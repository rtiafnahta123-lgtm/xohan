...
**Welcome to your Localhost project** 
...
Any change pushed to the repo will also be reflected in your local environment.
2. Navigate to the project directory
```
VITE_LOCALHOST_APP_ID=your_app_id
VITE_LOCALHOST_APP_BASE_URL=http://localhost:3000

```
VITE_LOCALHOST_APP_ID=local_app_id
VITE_LOCALHOST_APP_BASE_URL=http://localhost:3000
```
